...
1. Crear un arreglo de objetos: Define un arreglo llamado contactos que contenga al menos 3 objetos, cada uno representando Ia
información de una persona (nombre, puesto, empresa, correo electrónico, número de teléfono).
...
3. Mostrar las tarjetas: Utiliza un bucle para recorrer el arreglo contactos y, para cada contacto llama a la función y muestra la tafeta resultante en la consola.