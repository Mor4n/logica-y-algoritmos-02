...
![Captura de pantalla del HTML con el resultado del número máximo de un arreglo](./capturas/Captura2.png)
...
En esta práctica pude aprender sobre el paradigma de divide y vencerás, realmente recuerdo haberlo visto anteriormente en otros lados, pero no sabía que se podía aplicar de esta forma, en el sentido de hacer las cosas más pequeñas y luego hacer recursividad! Fue súper interesante de aprender :'D en este caso, me basé en el gist y también intenté probar mandandole datos desde un input como en los ejercicios anteriores y, en este caso, llegué a tener cierto error, ya que al momento de hacer el map del arreglo, tenía que convertir los elementos en lugar de string a numéricos, ya que estuve probando con números mediante el input y a veces no me daba el resultado que esperaba, por ello, los convertí a numéricos tipo flotante con parseFloat y con esto creo que pudo funcionar ya correctamente el programa :'D! Muchas gracias de verdad por sus enseñanzas!